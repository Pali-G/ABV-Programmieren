...
public class calculator
{
    ...
    public static void main(String[] args)
    {
		...
		if (args.length > 0) 
		{
		    term = args[0];
		    if (args.length > 1) 
		    {//Überprüfen pb zu viele Argument in Args
    ...
    public static double reduceTerm(String term)
    {
		...
		for (int i = 0; i <= (len-1); i++)
		{
			...
			//Wenn äußere Klammern da sind, mit neuen Term ohne Klammern reduceTerm erneut aufrufen
		    	...
		    	{//Wenn ein minus außerhalb von Klammern enthalten ist. Damit Das minus nicht einmal durch die i Schleife und einmal durch die j schleife aufgerufen wird, müssen beide übereinstimmen
		    	...
		    	{//Wenn der Term nur noch aus einer Zahl besteht, wird dieser in ein Double konvertiert
