...
public class hello_world
{
  ...
  //muss public sein damit auf die main-Methode und damit das Programm zugegriffen werden kann
  {
...
In Eclipse:
Projekt -> File --> Export ->  Wähle "Runnable JAR file" im Ordner "Java" als Export-Wizard-> Export-Ziel festlegen
Im Terminal:
...
Die .jar Datei ist ein Zip-Archiv und enthält viele Dateien. In ihr werden zusätzlich auch Metadaten und andere Ressourcen wie z.B. Bilder gespeichert.
