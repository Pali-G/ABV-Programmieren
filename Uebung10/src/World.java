...
public class World {
	...
	private int width, height;	//größe der Welt = Anzahl der Tiles x und y Richtung
	private int[][] tileIDs;	// IDs der unterschiedlichen Tiles gespeichert in zweidimensionalem array[xcoordinate][ycoordinate]
	private int spawnX, spawnY;
	
	// Lädt unsere erstellte Welt von unserer World.txt über den Path in GameState
	...
	// Loops für die einzelnen Koordinaten und ordnet diesen die Tiles zu
	...
	//weißt die IDs ihrem Index in tileIDs zu
